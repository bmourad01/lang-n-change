...
Additionally, language definitions can be compiled to executable λProlog logic programs. Users can use this to run queries in order to test the behavior of their generated languages.
